		...
		success: function(message){
			/*if(typeof(message) != "object"){
				...
				for(var i = 0; i < message.length; i++){
					...
					a += "<td>" + message[i].Temperature + "</td>";
					a += "<td>" + message[i].Humidity + "</td>";
					a += "<td>" + message[i].PM10 + "</td>";
					a += "<td>" + message[i].PM25 + "</td>";
					a += "<td>" + message[i].PM100 + "</td>";
				}
...
window.addEventListener( "load", showdust2, false );
